...
set DataTypeSet [list \
		"ComplexData" "struct" "2" -1 [list ] [ list ] "" "" [list [list "mStrPtr" "char*" "var" -1] [list "mStrArr" "char*" "2" -1] [list "mStr" "char*" "" -1]]\
]
...
[ list  [list "D:\\Projects\\TAT\\test\\test0010\\mpr\\test.mpr" 1 6 13 ]\
]\
[ list \
 [list  1  0  ]\
 [list  0  1  ]\
