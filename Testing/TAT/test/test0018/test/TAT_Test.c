...
static TAT_SRC_FILE_DEF tat_TAT_Test_test_SrcFiles[] = {
	{"D:\\Projects\\TAT\\test\\test0018\\mpr\\test.mpr", 1, 6, 13 }};
...
ComplexData TAT_Ass_test_0_0 (TAT_TEST_INSTANCE *id) {
	...
	TAT_ComplexData_Cur->data.mStrPtr.data=(char**)malloc(2*sizeof(char*));
	TAT_ComplexData_Cur->data.mStrPtr.counter=2;
	TAT_ComplexData_Cur->data.mStrPtr.data[0]=(char*)malloc(strlen("qwe")+1);
	strcpy(TAT_ComplexData_Cur->data.mStrPtr.data[0],"qwe");
	TAT_ComplexData_Cur->data.mStrPtr.data[1]=(char*)malloc(strlen("rty")+1);
	strcpy(TAT_ComplexData_Cur->data.mStrPtr.data[1],"rty");
	TAT_ComplexData_Cur->data.mStrArr[0]=(char*)malloc(strlen("ui")+1);
	strcpy(TAT_ComplexData_Cur->data.mStrArr[0],"ui");
	TAT_ComplexData_Cur->data.mStrArr[1]=(char*)malloc(strlen("op")+1);
	strcpy(TAT_ComplexData_Cur->data.mStrArr[1],"op");
	TAT_ComplexData_Cur->data.mStr=(char*)malloc(strlen("123")+1);
	strcpy(TAT_ComplexData_Cur->data.mStr,"123");
	TAT_ComplexData_Cur->next=(ComplexData)malloc(sizeof(struct _ComplexData));
	TAT_ComplexData_Cur=TAT_ComplexData_Cur->next;
	TAT_ComplexData_Cur->next=0;
	TAT_ComplexData_Cur->data.mStrPtr.data=(char**)malloc(2*sizeof(char*));
	TAT_ComplexData_Cur->data.mStrPtr.counter=2;
	TAT_ComplexData_Cur->data.mStrPtr.data[0]=(char*)malloc(strlen("asd")+1);
	strcpy(TAT_ComplexData_Cur->data.mStrPtr.data[0],"asd");
	TAT_ComplexData_Cur->data.mStrPtr.data[1]=(char*)malloc(strlen("fgh")+1);
	strcpy(TAT_ComplexData_Cur->data.mStrPtr.data[1],"fgh");
	TAT_ComplexData_Cur->data.mStrArr[0]=(char*)malloc(strlen("jk")+1);
	strcpy(TAT_ComplexData_Cur->data.mStrArr[0],"jk");
	TAT_ComplexData_Cur->data.mStrArr[1]=(char*)malloc(strlen("l;")+1);
	strcpy(TAT_ComplexData_Cur->data.mStrArr[1],"l;");
	TAT_ComplexData_Cur->data.mStr=(char*)malloc(strlen("456")+1);
	strcpy(TAT_ComplexData_Cur->data.mStr,"456");
	return x;
}
int TAT_Cmp_test_1_0_1 (ComplexData x, TAT_TEST_INSTANCE *id) {
	TAT_ComplexData_Cur=x;
	if(TAT_ComplexData_Cur==0) return 1;
	if(TAT_ComplexData_Cur->data.mStrPtr.counter!=2) return 1;
	if(strcmp(TAT_ComplexData_Cur->data.mStrPtr.data[0],"qwe")) return 1;
	if(strcmp(TAT_ComplexData_Cur->data.mStrPtr.data[1],"rty")) return 1;
	if(strcmp(TAT_ComplexData_Cur->data.mStrArr[0],"ui")) return 1;
	if(strcmp(TAT_ComplexData_Cur->data.mStrArr[1],"op")) return 1;
	if(strcmp(TAT_ComplexData_Cur->data.mStr,"123")) return 1;
	TAT_ComplexData_Cur=TAT_ComplexData_Cur->next;
	if(TAT_ComplexData_Cur==0) return 1;
	if(TAT_ComplexData_Cur->data.mStrPtr.counter!=2) return 1;
	if(strcmp(TAT_ComplexData_Cur->data.mStrPtr.data[0],"asd")) return 1;
	if(strcmp(TAT_ComplexData_Cur->data.mStrPtr.data[1],"fgh")) return 1;
	if(strcmp(TAT_ComplexData_Cur->data.mStrArr[0],"jk")) return 1;
	if(strcmp(TAT_ComplexData_Cur->data.mStrArr[1],"l;")) return 1;
	if(strcmp(TAT_ComplexData_Cur->data.mStr,"456")) return 1;
	TAT_ComplexData_Cur=TAT_ComplexData_Cur->next;
	if(TAT_ComplexData_Cur!=0) return 1;
	return 0;
}
