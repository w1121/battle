...
set SignalSet [list \
"A"  "in"  [list ] [ list "Array3" ] [ list 2 ] [ list Param1 ] "C" 0 100\
"B"  "out"  [list ] [ list "Array3" ] [ list 2 ] [ list Param1 ] "C" 0 100\
]
...
set DataTypeSet [list \
		"Array1" "int" "var" -1 [list ] [ list ] "" "" [list]\
		"Array2" "Array1" "var" 0 [list ] [ list ] "" "" [list]\
		"Array3" "Array2" "var" 1 [list ] [ list ] "" "" [list]\
]
...
"A(res)"\
"B((:(:(:1,2:),(:3,4:):),(:(:5,6:),(:7,8:):):))"\
] [ list   [list "Array3" "res" 2]]\
[ list  [list "D:\\Projects\\TAT\\test\\test0003\\mpr\\test.mpr" 1 6 13 ]\
]\
[ list \
 [list  1  0  ]\
 [list  0  1  ]\
...
[ list \
[ list "send" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 0  PASS  [list [list 0 6 ] ] "" "" [list  0 [ list [ list "" [list ARRAY [list ARRAY [list ARRAY "1" "2"] [list ARRAY "3" "4"]] [list ARRAY [list ARRAY "5" "6"] [list ARRAY "7" "8"]]]  ]  ]  0 [ list REL "0" "0" ] ] ]\
[ list "recv" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 1  PASS  [list [list 0 8 ] ] "" "" [list  1 [ list [ list "res" [list ARRAY [list ARRAY [list ARRAY "8" "7"] [list ARRAY "6" "5"]] [list ARRAY [list ARRAY "4" "3"] [list ARRAY "2" "1"]]]  ]  ]  1 [ list REL "0" "0" ] ] ]\
[ list "send" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 2  PASS  [list [list 0 10 ] ] "" "" [list  0 [ list [ list "" "res"  ]  ]  2 [ list REL "0" "0" ] ] ]\
[ list "recv" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 3  PASS  [list [list 0 12 ] ] "" "" [list  1 [ list [ list "" [list ARRAY [list ARRAY [list ARRAY "1" "2"] [list ARRAY "3" "4"]] [list ARRAY [list ARRAY "5" "6"] [list ARRAY "7" "8"]]]  ]  ]  3 [ list REL "0" "0" ] ] ]\
] 1 0
