...
set DataTypeSet [list \
		"ComplexData" "struct" "" -1 [list ] [ list ] "" "" [list [list "mStrPtr" "char*" "var" -1] [list "mStrArr" "char*" "2" -1] [list "mStr" "char*" "" -1]]\
]
...
[ list  [list "D:\\Projects\\TAT\\test\\test0014\\mpr\\test.mpr" 1 6 13 ]\
]\
[ list \
 [list  1  0  ]\
 [list  0  1  ]\
...
[ list \
[ list "send" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 0  PASS  [list [list 0 6 ] ] "" "" [list  0 [ list [ list "" [list STRUCT [list ARRAY "\"qwe\"" "\"rty\""] [list ARRAY "\"ui\"" "\"op\""] "\"123\""]  ]  ]  0 [ list REL "0" "0" ] ] ]\
[ list "recv" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 1  PASS  [list [list 0 8 ] ] "" "" [list  1 [ list [ list "x" [list STRUCT [list ARRAY "\"qwe\"" "\"rty\""] [list ARRAY "\"ui\"" "\"op\""] "\"123\""]  ]  ]  1 [ list REL "0" "0" ] ] ]\
