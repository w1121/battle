		...
		case TAT_S_A_ID:
			{
				...
				x=TAT_Copy_ComplexData(((TAT_SIG_A *)event->eventData)->Param1);
				TAT_Test_Recv_B(x,TAT_I_IUT_ID,TAT_I_Test_ID);
				TAT_Free_ComplexData(&(((TAT_SIG_A *)event->eventData)->Param1));
				break;
			}
		default:
			{
...
*
*************************************************************************************/
int TAT_Test_Recv_B(ComplexData Param1, int from, int to)
{
