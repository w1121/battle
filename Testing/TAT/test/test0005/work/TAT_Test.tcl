...
set DataTypeSet [list \
		"ComplexData" "struct" "var" -1 [list ] [ list ] "" "" [list [list "mIntPtr" "int" "var" -1] [list "mIntArr" "int" "2" -1] [list "mInt" "int" "" -1]]\
]
...
[ list  [list "D:\\Projects\\TAT\\test\\test0005\\mpr\\test.mpr" 1 6 17 ]\
]\
[ list \
 [list  1  0  ]\
 [list  0  1  ]\
...
[ list \
[ list "send" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 0  PASS  [list [list 0 6 ] ] "" "" [list  0 [ list [ list "" [list ARRAY [list STRUCT [list ARRAY "1" "2"] [list ARRAY "3" "4"] "5"] [list STRUCT [list ARRAY "6" "7"] [list ARRAY "8" "9"] "0"]]  ]  ]  0 [ list REL "0" "0" ] ] ]\
[ list "recv" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 1  PASS  [list [list 0 8 ] ] "" "" [list  1 [ list [ list "x" [list ARRAY [list STRUCT [list ARRAY "1" "2"] [list ARRAY "3" "4"] "5"] [list STRUCT [list ARRAY "6" "7"] [list ARRAY "8" "9"] "0"]]  ]  ]  1 [ list REL "0" "0" ] ] ]\
...
[ list "send" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 4  PASS  [list [list 0 14 ] ] "" "" [list  0 [ list [ list "" [list ARRAY ]  ]  ]  4 [ list REL "0" "0" ] ] ]\
[ list "recv" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 5  PASS  [list [list 0 16 ] ] "" "" [list  1 [ list [ list "" [list ARRAY ]  ]  ]  5 [ list REL "0" "0" ] ] ]\
] 1 0
