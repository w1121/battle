...
set DataTypeSet [list \
		"ComplexData" "struct" "list" -1 [list ] [ list ] "" "" [list [list "mIntPtr" "int" "var" -1] [list "mIntArr" "int" "2" -1] [list "mInt" "int" "" -1]]\
]
...
[ list  [list "D:\\Projects\\TAT\\test\\test0017\\mpr\\test.mpr" 1 6 13 ]\
]\
[ list \
 [list  1  0  ]\
 [list  0  1  ]\
