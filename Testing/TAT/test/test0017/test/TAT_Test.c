...
static TAT_SRC_FILE_DEF tat_TAT_Test_test_SrcFiles[] = {
	{"D:\\Projects\\TAT\\test\\test0017\\mpr\\test.mpr", 1, 6, 13 }};
...
ComplexData TAT_Ass_test_0_0 (TAT_TEST_INSTANCE *id) {
	...
	TAT_ComplexData_Cur->data.mIntPtr.data=(int*)malloc(2*sizeof(int));
	TAT_ComplexData_Cur->data.mIntPtr.counter=2;
	TAT_ComplexData_Cur->data.mIntPtr.data[0]=1;
	TAT_ComplexData_Cur->data.mIntPtr.data[1]=2;
	TAT_ComplexData_Cur->data.mIntArr[0]=3;
	TAT_ComplexData_Cur->data.mIntArr[1]=4;
	TAT_ComplexData_Cur->data.mInt=5;
	TAT_ComplexData_Cur->next=(ComplexData)malloc(sizeof(struct _ComplexData));
	TAT_ComplexData_Cur=TAT_ComplexData_Cur->next;
	TAT_ComplexData_Cur->next=0;
	TAT_ComplexData_Cur->data.mIntPtr.data=(int*)malloc(2*sizeof(int));
	TAT_ComplexData_Cur->data.mIntPtr.counter=2;
	TAT_ComplexData_Cur->data.mIntPtr.data[0]=6;
	TAT_ComplexData_Cur->data.mIntPtr.data[1]=7;
	TAT_ComplexData_Cur->data.mIntArr[0]=8;
	TAT_ComplexData_Cur->data.mIntArr[1]=9;
	TAT_ComplexData_Cur->data.mInt=0;
	return x;
}
int TAT_Cmp_test_1_0_1 (ComplexData x, TAT_TEST_INSTANCE *id) {
	TAT_ComplexData_Cur=x;
	if(TAT_ComplexData_Cur==0) return 1;
	if(TAT_ComplexData_Cur->data.mIntPtr.counter!=2) return 1;
	if(TAT_ComplexData_Cur->data.mIntPtr.data[0]!=1) return 1;
	if(TAT_ComplexData_Cur->data.mIntPtr.data[1]!=2) return 1;
	if(TAT_ComplexData_Cur->data.mIntArr[0]!=3) return 1;
	if(TAT_ComplexData_Cur->data.mIntArr[1]!=4) return 1;
	if(TAT_ComplexData_Cur->data.mInt!=5) return 1;
	TAT_ComplexData_Cur=TAT_ComplexData_Cur->next;
	if(TAT_ComplexData_Cur==0) return 1;
	if(TAT_ComplexData_Cur->data.mIntPtr.counter!=2) return 1;
	if(TAT_ComplexData_Cur->data.mIntPtr.data[0]!=6) return 1;
	if(TAT_ComplexData_Cur->data.mIntPtr.data[1]!=7) return 1;
	if(TAT_ComplexData_Cur->data.mIntArr[0]!=8) return 1;
	if(TAT_ComplexData_Cur->data.mIntArr[1]!=9) return 1;
	if(TAT_ComplexData_Cur->data.mInt!=0) return 1;
	TAT_ComplexData_Cur=TAT_ComplexData_Cur->next;
	if(TAT_ComplexData_Cur!=0) return 1;
	return 0;
}
