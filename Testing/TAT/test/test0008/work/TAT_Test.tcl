...
set DataTypeSet [list \
		"ComplexData" "char*" "var" -1 [list ] [ list ] "" "" [list]\
]
...
[ list  [list "D:\\Projects\\TAT\\test\\test0008\\mpr\\test.mpr" 1 6 13 ]\
]\
[ list \
 [list  1  0  ]\
 [list  0  1  ]\
...
[ list \
[ list "send" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 0  PASS  [list [list 0 6 ] ] "" "" [list  0 [ list [ list "" [list ARRAY "\"qwe\"" "\"rty\"" "\"uiop\""]  ]  ]  0 [ list REL "0" "0" ] ] ]\
[ list "recv" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 1  PASS  [list [list 0 8 ] ] "" "" [list  1 [ list [ list "x" [list ARRAY "\"qwe\"" "\"rty\"" "\"uiop\""]  ]  ]  1 [ list REL "0" "0" ] ] ]\
