...
set DataTypeSet [list \
		"ComplexData" "struct" "" -1 [list ] [ list ] "" "" [list [list "mIntPtr" "int" "var" -1] [list "mIntArr" "int" "2" -1] [list "mInt" "int" "" -1]]\
]
...
[ list  [list "D:\\Projects\\TAT\\test\\test0013\\mpr\\test.mpr" 1 6 13 ]\
]\
[ list \
 [list  1  0  ]\
 [list  0  1  ]\
...
[ list \
[ list "send" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 0  PASS  [list [list 0 6 ] ] "" "" [list  0 [ list [ list "" [list STRUCT [list ARRAY "1" "2"] [list ARRAY "3" "4"] "5"]  ]  ]  0 [ list REL "0" "0" ] ] ]\
[ list "recv" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 1  PASS  [list [list 0 8 ] ] "" "" [list  1 [ list [ list "x" [list STRUCT [list ARRAY "1" "2"] [list ARRAY "3" "4"] "5"]  ]  ]  1 [ list REL "0" "0" ] ] ]\
