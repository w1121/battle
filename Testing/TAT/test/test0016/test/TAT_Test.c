...
static TAT_SRC_FILE_DEF tat_TAT_Test_test_SrcFiles[] = {
	{"D:\\Projects\\TAT\\test\\test0016\\mpr\\test.mpr", 1, 6, 13 }};
...
ComplexData TAT_Ass_test_0_0 (TAT_TEST_INSTANCE *id) {
	...
	TAT_ComplexData_Cur->data=(List2)malloc(sizeof(struct _List2));
	TAT_List2_Cur=TAT_ComplexData_Cur->data;
	TAT_List2_Cur->next=0;
	TAT_List2_Cur->data=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List2_Cur->data;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=1;
	TAT_List1_Cur->next=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List1_Cur->next;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=2;
	TAT_List1_Cur->next=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List1_Cur->next;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=3;
	TAT_List2_Cur->next=(List2)malloc(sizeof(struct _List2));
	TAT_List2_Cur=TAT_List2_Cur->next;
	TAT_List2_Cur->next=0;
	TAT_List2_Cur->data=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List2_Cur->data;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=4;
	TAT_List1_Cur->next=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List1_Cur->next;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=5;
	TAT_List1_Cur->next=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List1_Cur->next;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=6;
	...
	TAT_List1_Cur=TAT_List2_Cur->data;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=7;
	TAT_List1_Cur->next=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List1_Cur->next;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=8;
	TAT_List1_Cur->next=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List1_Cur->next;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=9;
	TAT_List2_Cur->next=(List2)malloc(sizeof(struct _List2));
	TAT_List2_Cur=TAT_List2_Cur->next;
	TAT_List2_Cur->next=0;
	TAT_List2_Cur->data=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List2_Cur->data;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=10;
	TAT_List1_Cur->next=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List1_Cur->next;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=11;
	TAT_List1_Cur->next=(List1)malloc(sizeof(struct _List1));
	TAT_List1_Cur=TAT_List1_Cur->next;
	TAT_List1_Cur->next=0;
	TAT_List1_Cur->data=12;
	return x;
}
int TAT_Cmp_test_1_0_1 (ComplexData x, TAT_TEST_INSTANCE *id) {
	...
	TAT_List2_Cur=TAT_ComplexData_Cur->data;
	if(TAT_List2_Cur==0) return 1;
	TAT_List1_Cur=TAT_List2_Cur->data;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=1) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=2) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=3) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur!=0) return 1;
	TAT_List2_Cur=TAT_List2_Cur->next;
	if(TAT_List2_Cur==0) return 1;
	TAT_List1_Cur=TAT_List2_Cur->data;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=4) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=5) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=6) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur!=0) return 1;
	TAT_List2_Cur=TAT_List2_Cur->next;
	if(TAT_List2_Cur!=0) return 1;
	...
	TAT_List1_Cur=TAT_List2_Cur->data;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=7) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=8) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=9) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur!=0) return 1;
	TAT_List2_Cur=TAT_List2_Cur->next;
	if(TAT_List2_Cur==0) return 1;
	TAT_List1_Cur=TAT_List2_Cur->data;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=10) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=11) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur==0) return 1;
	if(TAT_List1_Cur->data!=12) return 1;
	TAT_List1_Cur=TAT_List1_Cur->next;
	if(TAT_List1_Cur!=0) return 1;
	TAT_List2_Cur=TAT_List2_Cur->next;
	if(TAT_List2_Cur!=0) return 1;
