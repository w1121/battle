...
set DataTypeSet [list \
		"ComplexData" "List2" "list" 2 [list ] [ list ] "" "" [list]\
		"List1" "int" "list" -1 [list ] [ list ] "" "" [list]\
		"List2" "List1" "list" 1 [list ] [ list ] "" "" [list]\
]
...
[ list  [list "D:\\Projects\\TAT\\test\\test0016\\mpr\\test.mpr" 1 6 13 ]\
]\
[ list \
 [list  1  0  ]\
 [list  0  1  ]\
...
[ list \
[ list "send" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 0  PASS  [list [list 0 6 ] ] "" "" [list  0 [ list [ list "" [list ARRAY [list ARRAY [list ARRAY "1" "2" "3"] [list ARRAY "4" "5" "6"]] [list ARRAY [list ARRAY "7" "8" "9"] [list ARRAY "10" "11" "12"]]]  ]  ]  0 [ list REL "0" "0" ] ] ]\
[ list "recv" [list [ list REL "0" "INF" ] [ list REL "0" "INF" ] ] [list ] [list ] "" 1  PASS  [list [list 0 8 ] ] "" "" [list  1 [ list [ list "x" [list ARRAY [list ARRAY [list ARRAY "1" "2" "3"] [list ARRAY "4" "5" "6"]] [list ARRAY [list ARRAY "7" "8" "9"] [list ARRAY "10" "11" "12"]]]  ]  ]  1 [ list REL "0" "0" ] ] ]\
