...
#define VERSION_1	1
#define VERSION_2	2
int ProtocolVersion; // version of GUI protocol
...
//===============================================================================
//=void PushMap(void)============================================================
extern "C" const char* getMapPath(void);

void PushMap(void)
{
	const char *MapPath = getMapPath();
	if(MapPath == NULL)
	{
		fprintf(stderr, "Map Path is not set yet.");
		return;
	}
			  ...
			  )
{
	...
	if (State == PushingShots)
	{
		...
		if (ProtocolVersion != VERSION_1) intBuffer.push_back((u_long)ShotId);
		g_NumElements++;
	}
}
//=End of PushShot===============================================================
